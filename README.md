...
Third of a three-part series on the same dataset: [static exploratory analysis](https://github.com/Tanos3000/sales-performance-analysis) → [interactive dashboard](https://github.com/Tanos3000/sales-kpi-dashboard) → natural-language query agent (this repo).
